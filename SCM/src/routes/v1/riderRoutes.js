...
// const { subscribeRiderToChannels } = require('../../controllers/riderController/subscribeRiderToChannels');
...
// router.put('/accept-booking/:bookingId',selectBooking);
...
// router.post('/api/subscribeRider', async (req, res) => {
//   const { riderId, lat, lng } = req.body;

//   // Call the subscription logic
//   await subscribeRiderToChannels(riderId, lat, lng);

//   res.status(200).json({ message: 'Rider subscribed successfully' });
// });
